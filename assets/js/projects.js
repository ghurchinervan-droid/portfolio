...
const PROJECTS = [
  ...
  },
  {
    ...
    tags: ["Brand Identity", "Logo", "Café-bar", "Vancouver", "Stationery", "Signage", "Packaging", "Merch"],
    ...
    gallery: [
      ...
      { src: "assets/img/projects/brisk/apron-white.png", caption: "Staff apron (white)" },
      { src: "assets/img/projects/brisk/apron-black.png", caption: "Staff apron (black)" },
      { src: "assets/img/projects/brisk/napkin-white.png", caption: "Embossed napkin (white)" },
      { src: "assets/img/projects/brisk/napkin-cream.png", caption: "Embossed napkin (cream)" },
      { src: "assets/img/projects/brisk/napkin-black.png", caption: "Embossed napkin (black)" },
      { src: "assets/img/projects/brisk/pastry-bag.png", caption: "Pastry take-away bag" },
      { src: "assets/img/projects/brisk/takeaway-bags.png", caption: "Take-away paper bags — sizes lineup" },
      { src: "assets/img/projects/brisk/packaging-set.png", caption: "Full food-packaging set — burger box, drink cup, wrap, take-away bag & fry box" },
      { src: "assets/img/projects/brisk/tote-white.png", caption: "Canvas tote bag (white)" },
      { src: "assets/img/projects/brisk/tote-black.png", caption: "Canvas tote bag (black)" },
      { src: "assets/img/projects/brisk/collection.png", caption: "Full café-bar collateral set" },
    ],
    meta: {
      "Designer": "Nervan Ghurchi",
      "Location": "Vancouver, Canada",
      "Deliverables": "Logo, cards, menu, letterhead, signage, glassware, aprons, napkins, take-away packaging, tote bags",
  ...
  },
  {
    ...
    tags: ["Brand Identity", "Logo", "Persian Type", "Monogram", "Instagram Shop", "Packaging", "Merch"],
    ...
    gallery: [
      ...
      { src: "assets/img/projects/mosalas/shipping-box.png", caption: "MOSALAS — delivery box for larger orders" },
      { src: "assets/img/projects/mosalas/shopping-bags.png", caption: "MOSALAS — kraft shopping bags in four sizes" },
      { src: "assets/img/projects/mosalas/envelope.png", caption: "MOSALAS — kraft envelope for smaller items" },
    ...
    meta: {
      ...
      "Deliverables": "Logo, business card, letterhead, apparel, merch, delivery packaging",
